...
private fun SanbotService.readGrammer() {
...
private fun SanbotService.facial() {
...
private fun SanbotService.move() {
    val motion = NoAngleWheelMotion(NoAngleWheelMotion.ACTION_FORWARD, 5, 3000)
    wheelManager.doNoAngleMotion(motion)
}


private fun SanbotService.wander(wander: Boolean) {
    modularMotionManager.switchWander(wander)
}

private fun SanbotService.moveHead() {
...
private fun SanbotService.moveWings() {
//        Parameter
//        Description
...
private fun SanbotService.handleVision() {
